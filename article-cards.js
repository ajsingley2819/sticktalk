// This script will scan the articles/ folder, extract the first image, title, and subject from each HTML file, and generate article cards dynamically on the main page.
