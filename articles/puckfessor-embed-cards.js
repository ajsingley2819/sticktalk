// Dynamically generate Puckfessor article cards in the embedded section of sample-hockey.html
(async function() {
  const articlesFolder = 'puckfessor/';
  const articleFiles = ['Example Document.html'];
  const cardContainer = document.querySelector('.puckfessor-articles-section .static-article-list');
